   ...
   <div className="grid lg:grid-cols-2 gap-8">
    ...
    <div className="bg-cover bg-[url('/05.jpg')] shadow-md border-t-2 px-4 py-8">
     <div className=" mx-auto backdrop-blur-2xl text-neutral-50 font-bold p-4 max-w-md backdrop-invert-0">
      ...
      <p>At FestLink, we&apos;re thrilled to introduce a revolutionary chapter in courier services tailored just for you. Picture this-real-time tracking at your fingertips, swift drone deliveries, and personalized experiences driven by state-of-the-art technology.</p>
     </div>
    </div>
